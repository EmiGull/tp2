...
export class Nivel2 extends Phaser.Scene {
  ...
  preload() {
    this.load.tilemapTiledJSON("level2", "public/assets/tilemaps/nivel2.json");
    this.load.image("tilesBelow", "public/assets/images/fondonivel2.png");
  ...
  create() {
    ...
    const tilesetBelow = map.addTilesetImage("fondonivel2", "tilesBelow");
    ...
    objectsLayer.objects.forEach((objData) => {
      ...
      switch (name) {
        case "star": {
          ...
          star2.setBounceY(Phaser.Math.FloatBetween(0.4, 0.8));
          break;
        }
